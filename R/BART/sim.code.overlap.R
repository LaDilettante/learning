...
xt=as.matrix(xt)
xp1=xt[xt[,"treat"]==1,] # Treated obs
xp2=xp1
xp1[,ncol(xt)]=1 # Treated obs covariates, labelled as treated
xp2[,ncol(xt)]=0 # Treated obs covariates, labelled as non-treated
xp=rbind(xp1,xp2) # rbind together
# xt will be BART's x.train, xp will be BART's x.test later
